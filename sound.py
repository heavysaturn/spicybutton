...
def play_note(note_name, duration):
    """
    This plays a note based on the name of the note
    instead of the frequency.
    """

    assert isinstance(note_name, str), "note_name must be a string."
    assert len(note_name) > 0, "You cannot pass an empty string into play_note"

    # Check if they included octave, if not default to 4.
